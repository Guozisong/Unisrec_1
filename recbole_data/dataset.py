...
class UniSRecDataset(SequentialDataset):
    def __init__(self, config):
        ...
        plm_embedding_weight = self.load_plm_embedding1()
        ...
        if config['train_stage'] == 'pretrain':
            ...
            plm_embedding_weight_aug = self.load_plm_embedding2()
    ...
    def load_plm_embedding1(self):
        feat_path = osp.join(self.config['data_path'],
        ...
        for i, token in enumerate(self.field2id_token['item_id']):  # i:整数id, token:原始值
